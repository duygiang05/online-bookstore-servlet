...
<main>
    <div class="container">
        <c:if test="${updated}">
            <div class="success-banner">Cập nhật trạng thái thành công.</div>
        </c:if>
        ...
        <div class="order-detail-header">
            <div>
                ...
                <p class="page-subtitle">
                    Khách: ${order.user.full_name} (${order.user.email})<br>
                    Ngày đặt:
                ...
                <c:forEach items="${order.items}" var="item">
                    <article class="cart-item" style="grid-template-columns: 1fr auto;">
                        <div class="cart-item__info">
                            <h2 class="cart-item__title">${item.bookTitle}</h2>
        ...
        <section class="form-card" style="margin-top: 1.5rem;">
            <h2 class="order-section-title">Cập nhật trạng thái</h2>
        ...
        <p style="margin-top: 1.5rem;">
            <a href="${pageContext.request.contextPath}/admin/order" class="btn btn-outline">Quay lại danh sách</a>
        </p>
    </div>
</main>
